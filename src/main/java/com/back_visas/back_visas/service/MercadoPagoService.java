...
public class MercadoPagoService implements iMercadoPagoService {
    ...
    public Map<String, Object> createPreference(CreatePreferenceRequest request) throws Exception {
        ...
        backUrls.put("success", "https://" + urlNotification + "/payment/success?order=" + order.getIdOrder());
        backUrls.put("failure", "https://" + urlNotification  + "/payment/failure?order=" + order.getIdOrder());
        backUrls.put("pending", "https://" + urlNotification + "/payment/pending?order=" + order.getIdOrder());
